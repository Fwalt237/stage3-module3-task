...
public class ValidationAspect {
    ...
    public void validateBeforeValidation(final JoinPoint joinPoint) throws NoSuchMethodException {
        if(joinPoint.getSignature() instanceof MethodSignature signature) {
            ...
            if(!violations.isEmpty()) {
                throw new ValidatorException(String.format(VALIDATION.getMessage(), violations));
            }
